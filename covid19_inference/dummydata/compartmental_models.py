...
# @Last Modified: 2020-06-04 14:53:26
# ------------------------------------------------------------------------------ #
...
def SEIR(lambda_t, model=None):
    ...
    def f(t, y_t):
        ...
        dS = -λ * S * I / N
        dE = λ * S * I / N - model.initials["SEIR"]["epsilon"] * E
        dI = model.initials["SEIR"]["epsilon"] * E - model.initials["SEIR"]["gamma"] *I
        dR = model.initials["SEIR"]["gamma"] * I
    ...
    y_t = np.array(y_t)
    return t_n , y_t[:,0], y_t[:,1], y_t[:,2], y_t[:,3]
