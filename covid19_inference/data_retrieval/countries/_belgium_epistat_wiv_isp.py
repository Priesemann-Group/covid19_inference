...
class Epistat_wiv_isp(Retrieval):
    ...
    def data(self):
        if (
            ...
            or self.hospitilization is None
            or self.deaths is None
            or self.tests is None
        ):
            return None
        return (self.confirmed, self.hospitilization, self.deaths, self.tests)
    ...
    def _fallback_local_backup(self):
        ...
        self.hospitilization = pd.read_csv(path_hospitilized, **self.kwargs)
